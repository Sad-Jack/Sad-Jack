...
**🤖 ML / AI**
- [Voice Wheel](https://github.com/Sad-Jack/voice-wheel) — AI-голосовой буфер обмена для macOS: зажал кнопку, сказал, выбрал режим — вставился обработанный текст
...
- [Selenium + Python (курс Stepik)](https://github.com/Sad-Jack/stepik_auto_tests_course) — задания курса по автоматизации тестирования

**📚 Kotlin-практика**
- [AndroidSprint](https://github.com/Sad-Jack/AndroidSprint) — задания учебного курса по Kotlin
- [QuoteParser](https://github.com/Sad-Jack/QuoteParser) — учебный парсер на Kotlin
